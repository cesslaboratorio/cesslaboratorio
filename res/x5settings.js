(function ( $, x5engine ) {
	...
	s.siteId = '2B87A571257B8B77DA53A6CA73E5E49F';
	s.version = '14-0-6-2';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function () {
		x.stickyBar({
			enabledBreakpoints: ['d6b072faa3ac87eabff241f8d95d2937','5ecdcca63de80fd3d4fbb36295d22b7d']
		});
	});
	...
	// BreakPoints
	s.breakPoints.push({ "hash": "68bb42a29766e1d307819d2956cb752d", "name": "Breakpoint 1", "start": "max", "end": 1280, "fluid": false});
	s.breakPoints.push({ "hash": "d6b072faa3ac87eabff241f8d95d2937", "name": "Mobile", "start": 1279, "end": 720, "fluid": false});
